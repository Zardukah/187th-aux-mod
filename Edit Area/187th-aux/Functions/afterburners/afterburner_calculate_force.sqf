...
_canUserAfterburner=[_vehicleType] call OES_fnc_afterburner_can_use;

if( !_canUserAfterburner) exitWith {0};

_vehicleForceArray=["CfgVehicles",_vehicleType,"OES_afterburner_force_array",[]] call OES_fnc_get_config_attribute;
