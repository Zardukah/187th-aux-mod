class CfgPatches
{
	class 187th_Airborne_Uniforms
	{
		...
		units[] = {"187th_CloneArmor_Airborne","187th_CloneArmor_Airborne_EOD","187th_CloneArmor_Airborne_Medic"};
		// List of weapons (CfgWeapons classes) contained in the addon.
		weapons[] = {"187th_Clone_Airborne","187th_Clone_Airborne_EOD","187th_Clone_Airborne_Medic"};
	};
};
